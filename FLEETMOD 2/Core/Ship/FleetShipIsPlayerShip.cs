...
namespace FLEETMOD_2.Core.Ship
{
    ...
    internal class FleetShipIsPlayerShip
    {
        ...
        {
            if (!Global.ModEnabled || __instance == null || !__instance.GameHasStarted || PLNetworkManager.Instance.LocalPlayer == null || !PLNetworkManager.Instance.LocalPlayer.GetHasStarted()) return;
